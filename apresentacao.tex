...
% TODO: Quando deixarmos de dar suporte a TeXLive 2023 (em 2027),
%       eliminar a opção "hyperref" de xcolor.
\documentclass[
...
\begin{frame}[allowframebreaks]{References}
  \nocite{dbevolution, shannon, FSF, natbib, biblatex,
          eco:09, alon09:how, curie, gridpat}
  \printbibliography
\end{frame}

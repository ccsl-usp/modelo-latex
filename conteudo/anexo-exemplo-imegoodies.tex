...
\begin{itemize}
  ...
  \item \cmd{pseudocode} carrega a ``linguagem'' pseudocódigo para a
        \textit{package} \cmd{listings}. Essa opção é ativada quando a
        opção \cmd{listings} é ativada; você pode ativá-la ou desativá-la
        incondicionalmente com \cmd{pseudocode} e \cmd{nopseudocode}

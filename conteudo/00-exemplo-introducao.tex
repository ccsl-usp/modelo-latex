...
\textsf{Google Scholar}\index{Google Scholar} (\href{http://scholar.google.com}
{scholar.google.com}). O \textsf{Web of Science}\index{Web of Science}
(\href{http://webofscience.com}{webofscience.com}) e o
\textsf{Scopus}\index{Scopus} (\href{http://scopus.com}{scopus.com})
...
ACM (\href{http://dl.acm.org}{dl.acm.org}) e a IEEE (\href
{http://ieeexplore.ieee.org}{ieeexplore.ieee.org}), também têm
...
\href{http://liinwww.ira.uka.de/bibliography}{liinwww.ira.uka.de/bibliography}
também permite buscar e baixar referências bibliográficas relevantes para a
área de computação.
...
periódicos (\href{http://periodicos.capes.gov.br}{periodicos.capes.gov.br}).
Existe uma extensão para os navegadores Chrome e Firefox (\href
{http://www.infis.ufu.br/capes-periodicos}{www.infis.ufu.br/capes-periodicos})
...
que você use uma ferramenta como Zotero~(\href{http://zotero.org}
{zotero.org})\index{Zotero} ou Mendeley~(\href{http://mendeley.com}
{mendeley.com})\index{Mendeley}. Ambas podem exportar seus dados no

...
livro de Justin Zobel, \emph{Writing for Computer Science}~\citep{zobel:14}
é uma leitura obrigatória. O livro \emph{Metodologia de Pesquisa para
Ciência da Computação} de Raul Sidnei~\citet{waz:20}
...
Mathematical Sciences}~\citep{higham:19} e o do criador do \TeX{}, Donald

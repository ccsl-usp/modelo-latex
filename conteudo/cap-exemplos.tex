...
Uma ``figura'', na verdade, também pode ser algum outro tipo
de conteúdo ilustrativo: um trecho de
código-fonte, como se vê na Figura~\ref{fig:java}, um cronograma,
como se vê na Figura~\ref{fig:gantt} etc.\index{Floats}

...
\item \textbf{Seria melhor usar menos \textit{packages} para processar mais rápido!}\\
\LaTeX{} carrega todas as \textit{packages} do modelo em cerca de \qty{1.5}{s}, ou seja, o que efetivamente toma tempo significativo é o processamento do documento em si. Substituindo o pacote \pkg{biblatex} por \pkg{bibtex} e \pkg{natbib}, o tempo das várias execuções necessárias para finalizar o documento é reduzido em cerca de \qty{5}{s}.

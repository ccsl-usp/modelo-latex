...
controle de versões, como mercurial (\href{http://mercurial-scm.org}
{mercurial-scm.org}) ou git (\href{http://git-scm.com}{git-scm.com}),
também é altamente recomendado.}. Este modelo é distribuído com uma
``colinha'' dos principais comandos \LaTeX{} e inclui comentários
explicativos para auxiliá-lo com ele, sendo composto dos arquivos:
...
Envie um relatório de erro ou entre em contato em \href
{http://gitlab.com/ccsl-usp/modelo-latex}{gitlab.com/ccsl-usp/modelo-latex}.

...
inclui comentários explicativos para auxiliá-lo com ele (não deixe de
ler também o Anexo~\ref{ann:imegoodlooks}). Os arquivos incluídos são:
...
\begin{itemize}
  ...
  \item \texttt{evenragged.sty}, \texttt{froufrou.sty}, \texttt{lstpseudocode.sty},
        \texttt{texlogsieve} e \texttt{texlog\-sieverc} (classes e programas

...
\href{http://www.gnuplot.info/docs\_5.2/Gnuplot\_5.2.pdf\#section*.516}
{www.gnuplot.info/docs\_5.2/Gnuplot\_5.2.pdf\#section*.516}}),
\cmd{matplotlib} (com o \emph{backend} \textsc{pgf}\footnote{\href
{http://matplotlib.org/users/pgf.html}{matplotlib.org/users/pgf.html}})
e \cmd{R} (com \cmd{tikzDevice}\footnote{\href
{http://cran.r-project.org/package=tikzDevice}
...
usar o sítio \href{http://www.tablesgenerator.com}{www.tablesgenerator.com}.};

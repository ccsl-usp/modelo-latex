...
\pkg{pgfplots}; \cmd{Gnuplot} é capaz de exportar gráficos na forma
de comandos para \pkg{tikz} (garantindo maior consistência visual entre
o texto principal e o gráfico), e o programa \cmd{Asymptote} tem
...
\begin{itemize}
    ...
    \textsc{Con\TeX{}t} é um ``irmão mais novo'' de \LaTeX{} com diversas

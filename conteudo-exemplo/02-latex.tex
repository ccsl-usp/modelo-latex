...
\url{www.andy-roberts.net/writing/latex}). O sítio \url{tex.stackexchange.com} é
...
(\textsf{texdoc simplified-intro}). O sítio \url{texdoc.net} oferece acesso
online a essa mesma documentação de maneira organizada e o sítio \url{ctan.org}
é o repositório semi-oficial das \textit{packages} \LaTeX{} e sua documentação.

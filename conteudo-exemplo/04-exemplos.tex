...
% Colocamos o label aqui porque ele não deve ficar em um
% cabeçalho/rodapé que se repete
...
% exceto a primeira; praticamente igual ao anterior, exceto
% pelo comando caption: como ele aparece em múltiplas páginas,
% ele não deve ser incluído na lista de tabelas, por isso
% usamos "[]". Ele também não deve ter um \label.

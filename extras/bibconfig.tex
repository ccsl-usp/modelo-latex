...
% Por padrão, biblatex mantém os títulos como digitados no arquivo bib,
% mas fornece a possibilidade de modificar esse comportamento em função
% da língua. Se a opção abaixo for ativada, plainnat-ime mantém
% maiúsculas/minúsculas como no arquivo .bib, exceto para artigos ou
% capítulos de livro (essa é uma convenção comum). Para mais opções,
% leia os comentários em plainnat-ime.bbx.
%

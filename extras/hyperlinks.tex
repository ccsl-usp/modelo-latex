...
% HACK ALERT! hyperxmp pode "confundir" latexmk, fazendo a compilação
% do documento entrar em um laço infinito. Talvez versões futuras da
% package eliminem esse problema; até lá, desabilitamos o recurso
% relacionado (o registro nos metadados de "byteCount", ou seja, o
% tamanho aproximado do documento).
\ifunicodeengine
\else

...
% para a inclusão de metadados de um documento no próprio documento.
...
% antes das opções relacionadas a metadados de hyperref serem ativadas
% (ou antes de carregar hyperref).
\usepackage{hyperxmp}
...
% Usamos "PassOptions" aqui porque outras packages definem opções
% para hyperref também e chamar a package com opções diretamente

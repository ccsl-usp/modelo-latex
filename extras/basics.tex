...
% Esta é uma das packages "padrão" da AMS, que são praticamente
% obrigatórias. Ela deve ser carregada antes de unicode-math
\usepackage{amssymb}
...
% Outras packages "padrão" da AMS.
% amsthm precisa ser carregada antes das definições de fontes.
\usepackage{amsthm}
\usepackage{amsmath}

...
% Acesso a símbolos adicionais, como \textrightarrow, \texteuro
% etc., disponíveis na maioria das fontes através do fontenc TS1
% ou mudando momentaneamente para computer modern/latin modern.
% Raramente útil com lualatex/xelatex, mas não causa problemas.
\usepackage{textcomp}

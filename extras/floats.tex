...
\newcounter{RCtempProgramCounter}
\usepackage{framed}
\newenvironment{ruledcaption}[2][]{
  ...
  \setcounter{RCtempProgramCounter}{\value{program}}

  \edef\RCtemparg{#1}
  \def\doCaption{
    \setcounter{program}{\value{RCtempProgramCounter}}
    \ifcsempty{RCtemparg}
  ...
  \def\MidFrameCommand{
    \CustomFBox
    {$\longrightarrow$\enspace\textit{cont}\par}
    {\hfill\textit{cont}\enspace$\longrightarrow$}
    {0pt}{0pt}{0pt}{0pt}
  }
  ...
  \vspace{.5\baselineskip plus .3\baselineskip minus 0pt}

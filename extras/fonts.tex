...
\else
    ...
    % diferentes}". Esta package resolve esse problema. Observe que esta
    % package só é necessária com pdfLaTeX; com fontspec (LuaLaTeX/XeLaTeX),
    % Small Caps + itálicos funcionam normalmente.
    \usepackage{slantsc}
\fi

...
\usepackage{listings}
\appto{\lstaspectfiles}{,imeusp-pseudocode.sty}
\appto{\lstlanguagefiles}{,imeusp-pseudocode.sty}
\lstloadaspectsfromsubdir{extras/}{simulatex,fixexcludedelims,pseudocode}
\lstloadlanguagesfromsubdir{extras/}{[base]pseudocode,[english]pseudocode,[brazil]pseudocode}
...
\lstset{
  ...
  framesep=5pt,
  defaultdialect=[english]{pseudocode},
}
...
\lstdefinestyle{pseudocode}{
  ...
  keywordstyle=[2]\bfseries\scshape,
...
% Novo tipo de float para programas, possível graças à package
% float, carregada em floats.tex
\floatstyle{ruled}
\ifcsdef{chapter}
...
% A lista de programas é criada automaticamente pela package float,
% mas precisamos definir o nome da lista em cada língua
\newcommand*\proglistname{List of Programs}
\addto\extrasbrazil{
  \renewcommand*\proglistname{Lista de Programas}
  \gdef\lstlistlistingname{Lista de Programas}
}
\addto\extrasenglish{
  \renewcommand*\proglistname{List of Programs}

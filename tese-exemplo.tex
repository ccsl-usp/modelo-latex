...
% primeira página; assim, forçamos uma quebra de página antes. Dependendo
% do formato final do seu sumário, você pode manter ou remover esta linha.
\addtocontents{toc}{\newpage}
\appendix
...
% Como em "Apêndices", você pode manter ou remover esta linha.
%\addtocontents{toc}{\newpage}
\annex

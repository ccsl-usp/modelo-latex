...
\begin{itemize}
  ...
  \item Arquivo com as packages usadas e suas configurações:
  \begin{itemize}
  ...
  \item Arquivo de dados bibliográficos:
  \begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \texttt{plainnat-ime.bst} (estilo plainnat com bibtex)\index{bibtex}
    \item \texttt{alpha-ime.bst} (estilo alpha com bibtex)\index{bibtex}
    \item \texttt{natbib-ime.sty} (tradução do pacote padrão natbib)\index{natbib}
    \item \texttt{hyperxindy.xdy} (arquivo de configuração de xindy para criar hiperlinks)
  \end{itemize}
\end{itemize}

...
\AtBeginBibliography{
  % Volta para o label default definido por beamer
  % (extras/bibconfig.tex modifica o label)
  \let\makelabel\originalmakelabel
  ...
  % entendi por quê (em apresentacao-exemplo isso funciona como
  % esperado).

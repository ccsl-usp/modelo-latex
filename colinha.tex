...
\quad\quad\textbackslash{}centering

\quad\quad\textbackslash{}includegraphics[width=\textbackslash{}textwidth]\{arquivo\}

\quad\quad\textbackslash{}caption\{Legenda\textbackslash{}label\{nomesimpatico\}\}
...
\textbackslash{}begin\{table\} (veja \url{www.tablesgenerator.com})

\quad\quad\textbackslash{}centering

\quad\quad\textbackslash{}begin\{tabular\}

\quad\quad\quad\ldots

\quad\quad\textbackslash{}end\{tabular\}
...
\textbackslash{}begin\{itemize\} (ou \textbackslash{}begin\{enumerate\})

\quad\quad\textbackslash{}item Algum texto\ldots

\textbackslash{}end\{itemize\} (ou \textbackslash{}end\{enumerate\})
...
\quad\quad\textbackslash{}item[termo] descrição ou discussão
...
\textbackslash{}begin\{verse\} (ver também a \textit{package} \textsf{verse})

\quad\quad verso\ldots\textbackslash\textbackslash
...
\begin{description}
  \item[URLs:] \textbackslash{}url\{endereço\}
\end{description}
...
\item[citação simples:]~\vspace{2pt}\newline
    \null\quad\quad\textbackslash{}cite[p.~25]\{fulano\} $\Rightarrow$ Fulano de Tal, 1987, p.~25\vspace{6pt}

  \item[citação no texto:]~\vspace{2pt}\newline
    \null\quad\quad\textbackslash{}cite\textbf{t}[p.~25]\{fulano\} $\Rightarrow$ Fulano de Tal (1987, p.~25)\vspace{6pt}

  \item[citação entre parênteses:]~\vspace{2pt}\newline
    \null\quad\quad\textbackslash{}cite\textbf{p}[p.~25]\{fulano\} $\Rightarrow$ (Fulano de Tal, 1987, p.~25)
\end{description}

\section*{Colunas}

\textbackslash{}begin\{multicols\}\{2\} (\textit{package} \textsf{multicols})

\quad\quad texto em colunas\dots
...
\begin{description}
  \item[elipse:] \textbackslash{}ldots
  ...
  \item[aspas:] \texttt{\`{}\`{}}texto\texttt{\textquotesingle\textquotesingle},
                \texttt{\`{}}texto\texttt{\textquotesingle}
  %\item[aspas:] \texttt{\textasciigrave\textasciigrave}texto\texttt{\textquotesingle\textquotesingle},
  %              \texttt{\textasciigrave}texto\texttt{\textquotesingle}
...
\begin{description}
  \item[não podem ser digitados diretamente:]~\vspace{2pt}\newline
    ...
    \quad\textbackslash{}\{
    \quad\textbackslash{}\}
    \quad\textbackslash{}textbackslash\{\}
\end{description}
...
\quad\quad texto centralizado\dots
